...
import axios from "../config/axiosInstance";
import { useNavigate } from "react-router-dom";
import { KeyRound, Mail, ShieldCheck, ChevronLeft, Lock, AlertTriangle } from "lucide-react";
import { toast } from "react-toastify";
                    ...
                    <form className="space-y-6" onSubmit={handleVerify}>
                        <div className="space-y-1.5">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                ...
                                <button
                                    ...
                                    onClick={handleGenerateOtp}
                                    disabled={otpLoading}
                                    className="bg-slate-900 hover:bg-slate-800 text-white font-bold px-6 py-3 rounded-xl transition-all shadow-sm hover:shadow-md cursor-pointer whitespace-nowrap disabled:opacity-50"
                                >
                        ...
                        <div className="pt-4">
                            <button
                                ...
                                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3.5 px-4 rounded-xl shadow-sm shadow-indigo-200 hover:shadow-indigo-300 transition-all hover:-translate-y-0.5 cursor-pointer disabled:opacity-50"
                            >
